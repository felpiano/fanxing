...
@Component
public class WeightedRandomSelectorNew {

    public static MerchantChannelEntity selectWeightedRandomly(List<MerchantChannelEntity> data) {
        // 构建Weighted对象列表
        List<Weighted<MerchantChannelEntity>> weightedData = Lists.newArrayList();
        int countWeight = 0;
        for (MerchantChannelEntity item : data) {
        ...
        Weighted<MerchantChannelEntity> selected = chooseWeightedRandomly(weightedData);
