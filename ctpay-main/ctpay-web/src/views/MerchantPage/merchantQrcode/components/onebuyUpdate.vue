...
<template>
  <el-dialog :title="isAdd ? '添加' : '编辑'" append-to-body :visible.sync="isVisible" width="36%" @close="closeDialog" :destroy-on-close="true">
    <el-form ref="form" :model="form" :rules="rule" label-width="140px" class="dialog-form-height">
      ...
      <el-form-item label="店铺名称" prop="nickName">
        <el-input v-model="form.nickName" placeholder="请输入店铺名称"></el-input>
      </el-form-item>
      <el-form-item label="店铺编号" prop="accountNumber">
        <el-input v-model="form.accountNumber" placeholder="请输入店铺编号"  :disabled="!isAdd"></el-input>
      </el-form-item>
