...
-->
<template>
  <el-dialog :title="`设置码商【${userName}】费率`" :visible.sync="isVisible" width="52%">
...
<script>
import {getMerchantChannelList, updateChannelRate} from '@/api/merchant'
    ...
    return {
      ...
      tableConfig:{
        ...
        columns: [
          ...
          { label: "渠道名称", value: "channelName", width: 140 },
          { label: "渠道编码(接口标识)", value: "channelCode", width: 160 },
          { label: "码商费率%", value: "channelRate", slot: "channelRate", width: 140 },
          { label: "押金(元)", value: "baseDeposit", slot: 'baseDeposit', width: 120 },
