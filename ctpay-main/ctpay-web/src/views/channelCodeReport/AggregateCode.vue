  ...
  <div class="app-container">
    ...
    <km-table :table="tableConfig" @tableChangeCurrent="tableChangeCurrent" @tableChangeSize="tableChangeSize" :toHeight="90">
      ...
      <template v-slot:qrcodeType="{ row }">
        <p class="ellipsis" v-if="row.qrcodeType === 2">无码</p>
        <el-button v-else type="text" size="mini" @click="handleClick(row)">查看二维码</el-button>
      </template>
    ...
    <el-dialog title="二维码" :visible.sync="dialogInfo.isShow" width="30%">
